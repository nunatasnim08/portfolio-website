...
import headerNidhi from "../assets/img/header-nidhi.svg";
import 'animate.css';
...
export const Banner = () => {
  ...
  const toRotate = [ "Software Engineer", "Frontend Developement Enthusiast"];
  const period = 2000;
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__zoomIn" : ""}>
                  <img src={headerNidhi} alt="Header Img"/>
                </div>}
            </TrackVisibility>
          </Col>
        </Row>
